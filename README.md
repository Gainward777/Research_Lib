...
`agent-skills/`. `library-development-workflow` автоматически координирует поиск,
запись, checkpoint и resume, поэтому разработчик не запускает эти сценарии
вручную. Клиентские среды устанавливают или адаптируют пакет у себя и
